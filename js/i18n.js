...
const dict = {
  it: {
    ...
    'faq.a2': 'Puoi pagare in contanti o con carta direttamente in studio al termine della seduta, oppure tramite bonifico bancario. Se hai esigenze particolari (fatturazione, rimborso assicurativo) scrivimi pure, così vediamo insieme la soluzione più comoda.',
  ...
  en: {
    ...
    'faq.a2': "You can pay in cash or by card directly at the clinic at the end of the session, or by bank transfer. If you have specific needs (invoicing, insurance reimbursement), just get in touch and we'll find the most convenient solution together.",
  ...
  fr: {
    ...
    'faq.a2': "Vous pouvez régler en espèces ou par carte directement au cabinet à la fin de la séance, ou par virement bancaire. Pour tout besoin particulier (facturation, remboursement par une assurance), contactez-moi et nous trouverons ensemble la solution la plus pratique.",
  ...
  es: {
    ...
    'faq.a2': 'Puedes pagar en efectivo o con tarjeta directamente en la consulta al final de la sesión, o mediante transferencia bancaria. Si tienes alguna necesidad particular (facturación, reembolso del seguro), escríbeme y buscamos juntos la solución más cómoda.',
  ...
  de: {
    ...
    'faq.a2': 'Sie können direkt in der Praxis am Ende der Sitzung bar oder mit Karte bezahlen, oder per Banküberweisung. Bei besonderen Bedürfnissen (Rechnungsstellung, Erstattung durch die Versicherung) schreiben Sie mir einfach, dann finden wir gemeinsam die passendste Lösung.',
